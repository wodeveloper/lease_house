...
{  
    ...
    {  
    	//删除hashmap中的值
    	TokenHelper.removeToken(request);
        return true;  
    }  
    ...
    {  
        try  
        {  
            response.getWriter().print("失败转换成json");  
        }  
        finally  
        {  
